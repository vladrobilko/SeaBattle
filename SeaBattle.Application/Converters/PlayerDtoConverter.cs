...
namespace SeaBattle.Application.Converters
{
    ...
    {
        public static PlayerModel ConvertToPlayerModel(this PlayerDtoModel playerDto)
        {
            return new PlayerModel() { Name = playerDto.Name };
        }

        public static List<PlayerModel> ConvertToListPlayerModel(this List<PlayerDtoModel> listPlayerDto)
        {
