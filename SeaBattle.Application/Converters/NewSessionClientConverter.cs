...
namespace SeaBattle.Application.Converters
{
    public static class NewSessionClientConverter
    {
        ...
        public static SessionDtoModel ConvertToNewSessionDto(this NewSessionClientModel newSessionClient)
        {
            return new SessionDtoModel { HostPlayerName = newSessionClient.HostPlayerName, SessionName = newSessionClient.SessionName };
        }
    }
}
