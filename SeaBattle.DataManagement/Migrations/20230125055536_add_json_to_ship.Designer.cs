...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.PlayareaDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.PlayerDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.SeabattleGameDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.SessionDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.ShipDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.ShootDto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.AppLog", b =>
                {
                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerNavigation")
                        .WithMany("AppLogs")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.SeabattleGameDto", b =>
                {
                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerTurnNavigation")
                    ...
                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerWinNavigation")
                    ...
                    b.HasOne("SeaBattle.DataManagement.Models.SessionDto", "IdSessionNavigation")
                        .WithOne("SeabattleGame")
                        .HasForeignKey("SeaBattle.DataManagement.Models.SeabattleGameDto", "IdSession")
                        .IsRequired()
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.SessionDto", b =>
                {
                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerHostNavigation")
                        .WithMany("SessionIdPlayerHostNavigations")
                        .HasForeignKey("IdPlayerHost")
                        .IsRequired()
                        .HasConstraintName("sessions_id_player_host_foreign");

                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerJoinNavigation")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.ShipDto", b =>
                {
                    b.HasOne("SeaBattle.DataManagement.Models.PlayareaDto", "IdPlayareaNavigation")
                        .WithMany("Ships")
            ...
            modelBuilder.Entity("SeaBattle.DataManagement.Models.ShootDto", b =>
                {
                    b.HasOne("SeaBattle.DataManagement.Models.PlayerDto", "IdPlayerShootNavigation")
                        .WithMany("Shoots")
                        .HasForeignKey("IdPlayerShoot")
                        .IsRequired()
                        .HasConstraintName("shoots_id_player_shoot_foreign");

                    b.HasOne("SeaBattle.DataManagement.Models.SeabattleGameDto", "IdSeabattleGameNavigation")
                        .WithOne("Shoot")
                        .HasForeignKey("SeaBattle.DataManagement.Models.ShootDto", "IdSeabattleGame")
                        .IsRequired()
